...
public class Fragementcaprureimage extends Fragment {
    ...
    public static Fragementcaprureimage newInstance() {
        return new Fragementcaprureimage();
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_fragementcaprureimage, container, false);
